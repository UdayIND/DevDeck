...
const faqs: Faq[] = [
  {
    ...
    icon: <Image src="/assets/lineicons/regular-free-icon-svgs/paint-bucket.svg" width={24} height={24} alt="About" />
  },
  {
    category: "About the App",
    ...
    icon: <Image src="/assets/lineicons/regular-free-icon-svgs/bolt-2.svg" width={24} height={24} alt="Features" />
  },
  {
    category: "About the App",
    ...
    icon: <Image src="/assets/lineicons/regular-free-icon-svgs/monitor.svg" width={24} height={24} alt="Platforms" />
  },
  {
    category: "About the App",
    ...
    icon: <Image src="/assets/lineicons/regular-free-icon-svgs/comment-1.svg" width={24} height={24} alt="Collaboration" />
  },
  {
    category: "About the App",
    ...
    icon: <Image src="/assets/lineicons/regular-free-icon-svgs/star-fat.svg" width={24} height={24} alt="Get Started" />
  },
  {
    ...
    icon: <Image src="/assets/lineicons/regular-free-icon-svgs/bolt-2.svg" width={24} height={24} alt="Shortcuts" />
  },
  {
    category: "Navigation",
    ...
    icon: <Image src="/assets/lineicons/regular-free-icon-svgs/menu-hamburger-1.svg" width={24} height={24} alt="Keyboard" />
  },
  {
    ...
    icon: <Image src="/assets/lineicons/regular-free-icon-svgs/paint-bucket.svg" width={24} height={24} alt="Canvas" />
  },
  {
    ...
    icon: <Image src="/assets/lineicons/regular-free-icon-svgs/layers-1.svg" width={24} height={24} alt="Layers" />
  },
  {
    ...
    icon: <Image src="/assets/lineicons/regular-free-icon-svgs/align-text-left.svg" width={24} height={24} alt="Text" />
  },
  {
    ...
    icon: <Image src="/assets/lineicons/regular-free-icon-svgs/cloud-upload.svg" width={24} height={24} alt="Export" />
  },
  {
    category: "Help",
    ...
    icon: <Image src="/assets/lineicons/regular-free-icon-svgs/message-2-question.svg" width={24} height={24} alt="Help" />
  },
];

const contactMethods: ContactMethod[] = [
  {
    icon: <Image src="/assets/lineicons/regular-free-icon-svgs/message-2-question.svg" width={24} height={24} alt="Mail" />,
    title: "Email Support",
  ...
  {
    icon: <Image src="/assets/lineicons/regular-free-icon-svgs/phone.svg" width={24} height={24} alt="Phone" />,
    title: "Phone Support",
...
const FaqPage: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-black text-white' : 'bg-gray-50 text-gray-900'} transition-colors duration-300`}>
      ...
      <NavbarComponent setIsMenuOpen={setIsMenuOpen} isMenuOpen={isMenuOpen} />
      </header>
