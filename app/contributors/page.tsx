...
import StarIcon from "../../public/assets/lineicons/regular-free-icon-svgs/star-fat.svg";
import ForkIcon from "../../public/assets/lineicons/regular-free-icon-svgs/gears-3.svg";
import NasaIcon from "../../public/assets/lineicons/regular-free-icon-svgs/nasa.svg";
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <StatCard 
              ...
              icon={<Image src={UsersIcon} width={32} height={32} alt="Users" />}
            />
            <StatCard 
              label="Total Contributions" 
              value={contributors.reduce((sum, contributor) => sum + contributor.contributions, 0)} 
              icon={<Image src={BoltIcon} width={32} height={32} alt="Bolt" />}
            />
            <StatCard 
              label="GitHub Stars" 
              value={repoStats.stars} 
              icon={<Image src={StarIcon} width={32} height={32} alt="Star" />}
            />
            <StatCard 
              label="Forks" 
              value={repoStats.forks} 
              icon={<Image src={ForkIcon} width={32} height={32} alt="Fork" />}
            />
          </div>
        </div>
      </section>
